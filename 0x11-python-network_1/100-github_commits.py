...
def main(argv):
    ...
    of the repository.The first argument should be the repository name
    and the second argument should be the owner's name
    """

    def print_commits(i, commit_list):
        """
        Lists the commits, less than 10 commits
        """
